...
| `src/content/posts/ecommerce-link-profit-model-rebuild.mdx` | `实践` | 批评用上周链接利润率估算本期推广利润的旧模型，并重构为订单级收入/成本、T-30～T-14 成熟金额退款率、广告费统一汇总的近 7 天链接利润表 | 写电商链接利润、广告投放盈亏、订单级成本、退款率口径和利润模型重构时参考 |
