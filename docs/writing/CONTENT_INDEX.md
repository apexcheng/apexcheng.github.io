...
| 文件 | 分类 | 主题概览 | 适合什么时候参考 |
| --- | --- | --- | --- |
| `src/content/posts/visual-lab/excel-formula-visual-patterns.mdx` | `视觉实验室` | 从 Excel 通配符文章中提炼公式教学可视化方法，展示数据样本、参数映射、字符槽位、错误结果反馈、复杂公式简化和移动端布局 | 写 Excel、WPS、SQL、正则表达式、数据筛选等教程，需要讲清公式参数、命中记录和最终结果之间的关系时参考 |
