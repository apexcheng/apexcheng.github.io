...
| `src/content/posts/ecommerce-price-hierarchy-target-price-planning.mdx` | `教程` | 用目标做到 85 元的实际案例，拆解一口价、价盘、单品宝、普卷价、超级立减、平时大促和双11 / 618之间的价格层级与倒推方法 | 写电商价格体系、活动卡控价、普卷价、营销工具和目标到手价倒推教程时参考 |
