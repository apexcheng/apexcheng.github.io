...
| `src/content/posts/excel-value-string-to-number.mdx` | `教程` | Excel VALUE 函数原理专题，用响应式信息图解释文本数字如何经过格式解析、合法性检查并转换为可计算数值 | 写 Excel 文本转数值、数字格式识别、VALUE 与 NUMBERVALUE 区别、数据类型转换教程时参考 |
