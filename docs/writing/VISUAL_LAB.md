...
涉及公式运行、数据处理、新旧方案对比、多阶段业务逻辑或自动化链路时，默认先参考下面的 P0 Demo。它提炼自两篇已经上线的正式文章，优先学习“让数据变化和中间结果可见”的组织方法，不逐块复制页面。

| 优先级 | 文件 | 用途 |
| --- | --- | --- |
| P0 | `src/content/posts/visual-lab/runtime-mechanism-visual-pattern.mdx` | 公式与业务逻辑的输入、处理、中间结果、边界和结论 |
